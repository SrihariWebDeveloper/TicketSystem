...
import { AnnouncementDetailPage, AnnouncementsPage, NewAnnouncementPage } from "./pages/Announcements";
...
export default function App() {
  return (
    <BrowserRouter><AuthProvider><TicketProvider><AnnouncementProvider><Routes>
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route path="/announcements/new" element={<RoleProtectedRoute role="Admin" />}><Route index element={<NewAnnouncementPage />} /></Route>
        <Route path="/announcements/:id" element={<AnnouncementDetailPage />} />
        <Route element={<RoleProtectedRoute role="Admin" />}><Route path="/users" element={<UsersPage />} /></Route>
        <Route path="*" element={<Navigate to="/dashboard" replace />} />
      </Route>
    </Routes></AnnouncementProvider></TicketProvider></AuthProvider></BrowserRouter>
  );
}
